...
def download_dataset():
    ...
    if not os.path.exists("./images.tar.gz"):
        safe_download(
            "https://huggingface.co/datasets/ziq/RSNA-ATD2023/resolve/main/data/images.tar.gz",
            dir=Path("."),
        )

    if not os.path.exists("./masks.tar.gz"):
        safe_download(
            "https://huggingface.co/datasets/ziq/RSNA-ATD2023/resolve/main/data/masks.tar.gz",
            dir=Path("."),
        )

    if not os.path.exists("./metadata.csv"):
        safe_download(
            "https://huggingface.co/datasets/ziq/RSNA-ATD2023/resolve/main/data/metadata.csv",
            dir=Path("."),
        )
